...
class ImageController extends AbstractController
{
     ...
     */
    //SUBMİTE BASTIĞIMIZDA NEW E GELİYOR.. BİR SÜRÜ FOTO EKLERKEN
    ...
    /**
     * @Route("/{id}/{did}", name="admin_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request,$did, Image $image): Response
    {
        ...
        return $this->redirectToRoute('admin_image_new',['id'=> $did]);
    }
}
